...
runTx(() => {
  ...
  updateSetting.run('Kuruyemişçim & Organik Ürünler', 'site_name');
  updateSetting.run('Taptaze, Doğal ve Kapınızda', 'site_tagline');
  updateSetting.run('destek@kuruyemiscim.com', 'contact_email');
  updateSetting.run('Konya, Türkiye (42030)', 'contact_address');
  console.log('Settings updated for Kuruyemişçim theme.');
});
